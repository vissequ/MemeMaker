...
// Default settings including the non-editable footer
let textData = {
    line1: {
        text: 'LINE 1 EXAMPLE',
        x: 50,
    ...
    footer: {
        text: 'GIFit.net',  // Defined here but enforced in drawCanvas
        x: 10,
        y: 0,              // Set dynamically later
        color: '#FFFFFF',
        font: 'Arial',
        size: 20,
        uppercase: false,  // Ignored due to hardcoding
        outline: false,
    },
};
...
function drawCanvas() {
    ...
    // Draw footer separately with exact specs
    ctx.font = '20px Arial';
    ctx.textAlign = 'left';
...
// Draw text line (excludes footer)
...
// Dragging logic (excludes footer)
...
// Hit detection (fixed template literal syntax)
